<template>
    <div>
        ...
        <v-row>
            ...
            <v-col md="1">
                <vs-button flat @click="getMaterialList()">ค้นหา</vs-button>
            </v-col>
            <v-col md="3">
...
export default {
    ...
    methods: {
        ...
        getMaterialList() {
            this.items = []
            fetch(process.env.VUE_APP_BACKEND + 'materials?populate=*&filters[raw_material_name][$contains]='+this.filter.text+'&pagination[page]='+this.page+'&pagination[pageSize]=10')

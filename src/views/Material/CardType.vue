                ...
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="12" md="12">
                            <vs-input type="text" label="รหัสประเภทวัตถุดิบ *" />
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <vs-input type="text" label="ชื่อประเภทวัตถุดิบ *" />
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <vs-select block label="หมวดหมู่ *" placeholder="Select" v-model="selected">

<template>
    <div>
        ...
        <vs-dialog v-model="dialog">
            <template #header>
                <h4 class="not-margin">{{ title }} จัดการข้อมูลประเภทต้นทุน</h4>
            </template>
            <div class="con-form">
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="12" md="12">
                            <vs-input type="text" label="รหัสประเภทต้นทุน *" />
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <vs-input type="text" label="ชื่อประเภทต้นทุน *" />
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                            <label>สถานะ *</label>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'รหัสประเภทต้นทุน', value: 'code' },
                { text: 'ชื่อประเภทต้นทุน', value: 'name' },

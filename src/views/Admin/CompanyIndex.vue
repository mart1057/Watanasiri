<template>
    <div>
        ...
        <vs-dialog v-model="dialog">
            <template #header>
                <h4 class="not-margin">{{ title }} จัดการข้อมูลบริษัท</h4>
            </template>
            <div class="con-form">
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="รหัสบริษัท *" readonly />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="ชื่อบริษัท *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="ที่อยู่ *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="เบอร์โทรศัพท์ *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">

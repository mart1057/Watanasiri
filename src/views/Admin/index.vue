<template>
    <div>
            ...
            <vs-table>
                ...
                <template #tbody>
                    <vs-tr :key="i" v-for="(item, i) in $vs.getPage(items, page, max)" :data="item">
                        ...
                        <vs-td>{{ item.position }}</vs-td>
                        <vs-td>{{ item.username }}</vs-td>
        ...
        <vs-dialog v-model="dialog">
            <template #header>
                <h4 class="not-margin">{{ title }} จัดการข้อมูลผู้ใช้</h4>
            </template>
            <div class="con-form">
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="รหัสผู้ใช้ *" readonly />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="ชื่อผู้ใช้ *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-select block label="ตำแหน่ง *" placeholder="Select" v-model="selected">
                        ...
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="username *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                            <vs-input type="text" label="password *" />
                        </v-col>
                        <v-col cols="12" sm="6" md="6">

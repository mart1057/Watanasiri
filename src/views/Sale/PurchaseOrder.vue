...
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'เลขที่ใบเสนอราคา', value: 'poCode' },
                { text: 'วันที่เสนอราคา', value: 'date' },
                { text: 'บริษัท', value: 'company' },
                { text: 'โครงการ', value: 'project' },
                { text: 'เรียน', value: 'contact' },
                { text: 'รวมเป็นเงินทั้งสิ้น', value: 'amount' },
                { text: 'ผู้เสนอราคา', value: 'user' },
    ...
    methods: {
        goto() {
            this.$router.push({ path: "/createpo" });
        },
        editItem(item) {
